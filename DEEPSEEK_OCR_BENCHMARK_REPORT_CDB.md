---
title: "DeepSeek VL OCR Benchmark - Finální Report"
date: 2025-12-03
author: Claude Code
version: 1.0
category: benchmarks
tags: [deepseek, ocr, benchmark, ollama, dgx, docker, performance-testing]
status: final
project: maj-document-recognition
hardware: [dgx-server, macbook-docker]
models-tested: [deepseek-ocr:3b, qwen2.5:32b, czech-finance-speed]
conclusion: reject
recommendation: keep-current-models
---
...
**Autor**: Claude Code
**Status**: FINAL
**Umístění**: /home/puzik/couchdb/deepseek-benchmark-2025-12-03/
**Related files**:
- benchmark_results.json (9.3 KB)
- deepseek_benchmark.log (13 KB)
