...
# Import AI Consensus
from ai_consensus_trainer_14b import AIVoter, LearningDatabase
...
class MBWDocumentTester:
    ...
    def __init__(self, mbw_dir: str):
        ...
        self.voter = AIVoter()
        self.learning_db = LearningDatabase('mbw_learning_patterns_14b.jsonl')
...
def main():
    ...
    # Save results
    results_file = 'mbw_test_results_14b.json'
    with open(results_file, 'w', encoding='utf-8') as f:
        json.dump(results, f, indent=2, ensure_ascii=False)

    print(f"\n💾 Results saved: {results_file}")
    print(f"💾 Learning patterns: mbw_learning_patterns_14b.jsonl")
    print("\n✅ MBW test complete!")
